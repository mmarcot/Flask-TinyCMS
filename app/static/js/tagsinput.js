...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$input = $('<input type="' + this.type + '" name="tagsinput_' + this.name + '" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
    // the above line has been changed because it sent the 'tags' input 2 times to the form target
    // original line:
